...
[![License](https://img.shields.io/badge/license-BSD-blue.svg)](https://github.com/Bnei-Baruch/sqlboiler/blob/master/LICENSE)
[![GoDoc](https://godoc.org/github.com/Bnei-Baruch/sqlboiler?status.svg)](https://godoc.org/github.com/Bnei-Baruch/sqlboiler)
...
[![CircleCI](https://circleci.com/gh/Bnei-Baruch/sqlboiler.svg?style=shield)](https://circleci.com/gh/Bnei-Baruch/sqlboiler)
[![Go Report Card](https://goreportcard.com/badge/Bnei-Baruch/sqlboiler)](http://goreportcard.com/report/Bnei-Baruch/sqlboiler)
...
```shell
go get -u -t github.com/Bnei-Baruch/sqlboiler
```
...
Complete documentation is available at http://github.com/Bnei-Baruch/sqlboiler
...
import . "github.com/Bnei-Baruch/sqlboiler/queries/qm"
...
For a comprehensive ruleset for `Bind()` you can refer to our [godoc](https://godoc.org/github.com/Bnei-Baruch/sqlboiler/queries#Bind).
...
by using the [boil.Begin()](https://godoc.org/github.com/Bnei-Baruch/sqlboiler/boil#Begin) function.
...
The homepage for the [SQLBoiler](https://github.com/Bnei-Baruch/sqlboiler) [Golang ORM](https://github.com/Bnei-Baruch/sqlboiler)
generator is located at: https://github.com/Bnei-Baruch/sqlboiler

## Benchmarks

If you'd like to run the benchmarks yourself check out our [boilbench](https://github.com/Bnei-Baruch/boilbench) repo.
