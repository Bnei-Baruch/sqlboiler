...
func TestCombineImports(t *testing.T) {
	...
	a := imports{
		...
		thirdParty: importList{"github.com/Bnei-Baruch/sqlboiler", "gopkg.in/Bnei-Baruch/null.v6"},
	}
	b := imports{
		standard:   importList{"os"},
		thirdParty: importList{"github.com/Bnei-Baruch/sqlboiler"},
	}
	...
	if c.thirdParty[0] != "github.com/Bnei-Baruch/sqlboiler" && c.thirdParty[1] != "gopkg.in/Bnei-Baruch/null.v6" {
		t.Errorf("Wanted: github.com/Bnei-Baruch/sqlboiler, gopkg.in/Bnei-Baruch/null.v6 got: %#v", c.thirdParty)
	}
}
